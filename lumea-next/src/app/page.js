  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', position: 'relative' }}>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', overflowX: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', top: '20%', left: '30%', width: '300px', height: '300px', background: 'radial-gradient(circle, rgba(99,102,241,0.15) 0%, rgba(0,0,0,0) 70%)', filter: 'blur(50px)', zIndex: -2 }}></div>
        <div style={{ position: 'absolute', bottom: '30%', right: '25%', width: '350px', height: '350px', background: 'radial-gradient(circle, rgba(168,85,247,0.1) 0%, rgba(0,0,0,0) 70%)', filter: 'blur(60px)', zIndex: -2 }}></div>
        ...
        <section style={{ 
          ...
          <p className="reveal" style={{ color: 'var(--muted)', fontSize: '1.25rem', maxWidth: '600px', margin: '0 0 2.5rem 0', lineHeight: '1.6' }}>
            Meet Lumea, your compassionate AI companion. A safe, structured space to talk, track patterns, and breathe better using secure frameworks.
          </p>
        ...
        <section id="features" style={{ width: '100%', maxWidth: '1100px', padding: '5rem 2rem', textAlign: 'center' }}>
          <h2 className="reveal" style={{ position: 'relative', fontSize: '2.5rem', marginBottom: '3.3rem', fontWeight: '800', display: 'inline-block' }}>
            <div className="neon-orb" style={{ width: '200px', height: '200px', background: '#6366f1', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', opacity: 0.2 }}></div>
          ...
          <div className="bento-grid">
            ...
            <div className="feature-card bento-8 reveal" style={{ padding: '2.5rem', transitionDelay: '0s', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', textAlign: 'left' }}>
              <div>
                <div style={{ width: '50px', height: '50px', background: 'linear-gradient(135deg, #6366f1 0%, #a855f7 100%)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.8rem', marginBottom: '1.5rem', boxShadow: '0 4px 15px rgba(99,102,241,0.4)' }}>💬</div>
              ...
              <div style={{ marginTop: '2rem', padding: '1.2rem', background: 'rgba(30, 41, 59, 0.4)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(255,255,255,0.04)' }}>
                <span style={{ color: '#818cf8', fontStyle: 'italic', fontSize: '0.95rem' }}>"I'm here to listen, exactly as you are."</span>
              </div>
            </div>
            ...
            <div className="feature-card bento-4 reveal" style={{ padding: '2.5rem', transitionDelay: '0.1s', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', textAlign: 'left' }}>
              <div>
                <div style={{ width: '50px', height: '50px', background: 'rgba(30, 41, 59, 0.6)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.8rem', marginBottom: '1.5rem' }}>📊</div>
              ...
              <div style={{ display: 'flex', gap: '0.6rem', alignItems: 'flex-end', height: '80px', marginTop: '2rem', padding: '0 0.5rem' }}>
                <div style={{ flex: 1, background: 'rgba(99, 102, 241, 0.2)', height: '40%', borderRadius: '4px' }}></div>
                <div style={{ flex: 1, background: 'rgba(99, 102, 241, 0.4)', height: '60%', borderRadius: '4px' }}></div>
                <div style={{ flex: 1, background: 'linear-gradient(to top, #6366f1, #a855f7)', height: '100%', borderRadius: '4px', boxShadow: '0 0 15px rgba(168, 85, 247, 0.4)' }}></div>
                <div style={{ flex: 1, background: 'rgba(99, 102, 241, 0.6)', height: '70%', borderRadius: '4px' }}></div>
                <div style={{ flex: 1, background: 'rgba(99, 102, 241, 0.3)', height: '50%', borderRadius: '4px' }}></div>
              </div>
            </div>
            ...
            <div className="feature-card bento-12 reveal" style={{ padding: '2.5rem', transitionDelay: '0.2s', display: 'flex', gap: '2rem', alignItems: 'center', flexWrap: 'wrap', textAlign: 'left' }}>
              <div style={{ flex: '1 1 300px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                ...
                <div style={{ display: 'flex', gap: '0.8rem', flexWrap: 'wrap' }}>
                  <span style={{ padding: '0.4rem 0.8rem', background: 'rgba(255,255,255,0.05)', borderRadius: '20px', fontSize: '0.75rem', color: '#818cf8', fontWeight: '600', letterSpacing: '0.5px' }}>Guided Prompts</span>
                  <span style={{ padding: '0.4rem 0.8rem', background: 'rgba(255,255,255,0.05)', borderRadius: '20px', fontSize: '0.75rem', color: '#818cf8', fontWeight: '600', letterSpacing: '0.5px' }}>🔒 End-to-End Privacy</span>
                </div>
              </div>
              <div style={{ flex: '1 1 200px', height: '180px', background: 'rgba(15, 23, 42, 0.4)', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', filter: 'grayscale(0.5) opacity(0.7)', border: '1px solid rgba(255,255,255,0.05)', overflow: 'hidden' }}>
        ...
        <section id="about" style={{ width: '100%', maxWidth: '900px', padding: '6rem 2rem', display: 'flex', alignItems: 'center', gap: '3rem', flexWrap: 'wrap' }}>
          ...
          <div className="reveal" style={{ flex: '1 1 300px', display: 'flex', justifyContent: 'center' }}>
            <div style={{ width: '100%', height: '300px', background: 'radial-gradient(transparent, rgba(139, 92, 246, 0.05)), url("https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?auto=format&fit=crop&w=600&q=80")', backgroundSize: 'cover', borderRadius: '30px', boxShadow: '0 20px 40px rgba(0,0,0,0.5)', border: '1px solid rgba(255,255,255,0.08)' }}></div>
          </div>
        </section>
        ...
        <section id="stories" style={{ width: '100%', maxWidth: '1100px', padding: '5rem 2rem', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
            {[
              ...
              <div key={idx} className="glass-card reveal" style={{ padding: '2.5rem', textAlign: 'left', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', border: '1px solid rgba(255,255,255,0.06)', transitionDelay: `${idx * 0.1}s` }}>
                <p style={{ fontStyle: 'italic', lineHeight: '1.6', marginBottom: '1.5rem', color: '#f1f5f9', fontSize: '1rem' }}>&quot;{story.quote}&quot;</p>
                <div>
                  <div style={{ fontWeight: '700', color: '#a855f7', fontSize: '0.95rem' }}>{story.author}</div>
                  <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: '0.2rem' }}>{story.tag}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="reveal" style={{ width: 'calc(100% - 4rem)', maxWidth: '1000px', margin: '4rem 2rem', padding: '0' }}>
          <div className="glass-card" style={{ padding: '3rem', textAlign: 'center', border: '1px solid rgba(239, 68, 68, 0.2)', backgroundColor: 'rgba(15, 23, 42, 0.6)' }}>
            <div style={{ fontSize: '2.5rem', marginBottom: '1rem' }}>🚨</div>
            <h2 style={{ fontSize: '1.8rem', color: '#f87171', marginBottom: '1rem', fontWeight: '800' }}>Safety Disclaimer</h2>
            <p style={{ color: '#e2e8f0', fontSize: '1.05rem', margin: '0 auto 2rem auto', maxWidth: '700px', lineHeight: '1.6' }}>
            ...
            <p style={{ color: 'var(--muted)', fontSize: '0.95rem' }}>
              ...
              <br />
              <strong style={{ color: 'white' }}>India: 104 (Health helpline) | AASRA or Vandrevala Foundation.</strong>
            </p>
          </div>
        </section>

        {/* 5. Contact / Footer */}
        <section id="contact" className="reveal" style={{ width: '100%', padding: '4rem 2rem', textAlign: 'center', borderTop: '1px solid rgba(255,255,255,0.05)', backgroundColor: 'rgba(2, 6, 23, 0.4)' }}>
